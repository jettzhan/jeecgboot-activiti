...
-- ----------------------------
-- Table structure for zh_leave_oa
-- ----------------------------
DROP TABLE IF EXISTS `zh_leave_oa`;
CREATE TABLE `zh_leave_oa`  (
  ...
  `name` varchar(200)  NULL DEFAULT NULL COMMENT '标题',
  `leave_day` int(0) NULL DEFAULT NULL COMMENT '请假天数',
  `reason` varchar(500)  NULL DEFAULT NULL COMMENT '请假理由',
