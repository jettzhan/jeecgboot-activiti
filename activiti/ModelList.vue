<template>
  <a-card :bordered="false">
    ...
    <a-modal
      ...
      width="100%"
      @cancel="cancelUpdate"
      class="process-design-modal"
    >
    <div style="height: calc(100vh - 80px)">
      <iframe  :src="iframUrl" frameborder="0" width="100%" height="100%" scrolling="auto" style="background-color: #fff;"></iframe>
    </div>
    </a-modal>
  </a-card>
    ...
    data () {
      return {
        ...
        url: {
          ...
          create: "/jeecg-boot/bpm/index.html",
          update: "/jeecg-boot/bpm/index.html",
        },
      }
    },
    methods: {
      ...
      createObjOk(e) {
        ...
        // this.iframUrl = `${window._CONFIG['domianURL']}${this.url.create}`
         this.iframUrl = `${this.url.create}?name=${this.createObj.name}&description=${this.createObj.description}&key=${this.createObj.key}`
      ...
      updatelc(id){
        ...
        this.$message
          ...
          .then(() => {
            ...
            _this.iframUrl = `${_this.url.update}?id=${id}`;
...
<style>
  .process-design-modal  .ant-modal{
    top: 0px !important;
